          ...
          <el-col :span="12">
            ...
            <el-card style="height: 550px">
              <div style="border-style: dashed;height: 512px;width: 512px;margin: auto">
                <el-image style="height: 512px;width: 512px" :src="'data:image/png;base64,'+this.image"></el-image>
              </div>
            </el-card>
          </el-col>
        </el-row>
...
import i0 from "@/assets/sketch/0.png"
import i1 from "@/assets/sketch/10.png"
...
export default {
  ...
  data(){
    return{
      canvas: null,
      image: require('/Users/qingyuan/Desktop/大三下/ai/src/assets/sketch/0.png'),
      ...
      examples: [{
        ...
        },
        {
          id: '3',
          alt: 'Alt Image 3',
          src: require('@/assets/sketch/20.png')
        },
        {
          src: require('@/assets/sketch/30.png')
        },
        {
          id: '3',
          alt: 'Alt Image 3',
          src: require('@/assets/sketch/40.png')
        },
        {
          id: '3',
          alt: 'Alt Image 3',
          src: require('@/assets/sketch/50.png')
        },
        {
          src: require('@/assets/sketch/60.png')
        },
        {
          src: require('@/assets/sketch/70.png')
        },
        {
          src: require('@/assets/sketch/80.png')
        },
        {
          src: require('@/assets/sketch/90.png')
        },
        {
          src: require('@/assets/sketch/100.png')
        }
      ]
    }
  },
